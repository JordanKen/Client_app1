...
--
-- Host: localhost:3306
-- Generation Time: Mar 14, 2021 at 06:57 PM
...
(103, 'Atelier graphique', 'Cariness', 'Cariness', '40.32.2555', '54, rue Royale', '', 'Nantes', '', '44000', 'France', 1370, '1370.00'),
...
(380, 'jordanken', 'JOrdan', 'JOrdan', '+44680087194', 'Douala Cameroun', 'HGFH', 'Douala', 'Littoral', '00237', NULL, NULL, '76576576.00');
...
--
ALTER TABLE `customers`
  MODIFY `customerNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=381;
